...
local tw_prompt_symbol_a=""
local tw_prompt_symbol_b="›"
local tw_prompt_symbol_c="›"
local tw_prompt_symbol_d="› "
if [ ! -z "$TYPEWRITTEN_SYMBOL" ]; then
  tw_prompt_symbol_b="$TYPEWRITTEN_SYMBOL"
fi;

local tw_base_symbol_color="%F{$tw_colors[symbol]}"
local tw_base_symbol_color_a="%F{#DDB6F2}"
local tw_base_symbol_color_b="%F{#F8BD96}"
local tw_base_symbol_color_c="%F{#B5E8E0}"
local tw_base_symbol_color_d="%F{#89DCEB}"
if [[ $(id -u) -eq 0 ]]; then
...
tw_prompt="$tw_base_symbol_color_a$tw_return_code$tw_prompt_symbol_a %F{$tw_colors[prompt]}$tw_base_symbol_color_b$tw_prompt_symbol_b%F{$tw_colors[prompt]}$tw_base_symbol_color_c$tw_prompt_symbol_c%F{$tw_colors[prompt]}$tw_base_symbol_color_d$tw_prompt_symbol_d%F{$tw_colors[prompt]}"
